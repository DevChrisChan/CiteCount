  ...
  function getModalsHTML() {
    return `
      ...
      <div class="paste-permission-content">
        ...
        <div class="mt-6 flex" style="gap:12px;">
      ...
      <div class="local-backup-reminder-dialog" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%) scale(0.98); background: var(--background-primary); color: var(--text-primary); border-radius: 16px; box-shadow: 0 20px 40px rgba(0,0,0,0.18); max-width: 520px; width: 92%; z-index: 10002; transition: opacity 0.15s ease, transform 0.15s ease; opacity: 0; overflow: hidden; border: 1px solid var(--border-primary);">
        ...
        <div style="background: #eef2ff; color: #312e81; padding: 12px; border-radius: 12px; flex-shrink: 0; display: grid; place-items: center;">
          <svg viewBox="0 0 24 24" width="26" height="26" fill="currentColor" aria-hidden="true" style="display: block;">
          <path d="M12 2a10 10 0 100 20 10 10 0 000-20zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"/>
          </svg>
        </div>
        <div style="flex: 1; min-width: 0;">
          <p style="margin: 0 0 8px 0; font-size: 1.05rem; font-weight: 700;">We noticed you've saved multiple files</p>
          <p style="margin: 0; color: var(--text-secondary); line-height: 1.5; font-size: 0.95rem;">CiteCount runs locally in your browser and does not backup your projects. While content is saved in your browser, to keep a copy safe, please periodically export your projects at Settings → General → Export all projects.</p>
        </div>
        ...
        <button id="local-backup-reminder-export" style="padding: 10px 14px; border-radius: 10px; border: none; background: #1f40af; color: white; font-weight: 700; cursor: pointer; flex: 1 1 140px;">Open Settings</button>
        </div>
      </div>
      </div>
