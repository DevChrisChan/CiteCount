...
document.addEventListener('DOMContentLoaded', function () {
  if (!allowedDomains.includes(currentDomain)) {
    ...
    warningDiv.innerHTML = 'Access Restricted<h2>Accessing CiteCount from forks compromises your data\'s safety.</h2>Please visit the official CiteCount application at <a href="https://citecount.netlify.app" style="text-decoration: underline;">citecount.netlify.app</a>';
